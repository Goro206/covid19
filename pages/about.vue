<template>
  <div class="About">
    ...
    <TextCard>
      当サイトは新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するために、東京都が開設したものを愛知県に適用したものです。<br />
      <br />
      個人のテスト版なので最新の情報が適用されているわけではありません。
    </TextCard>
    ...
    <TextCard title="データについて">
      本サイトで公表しているデータは、<a
        ...
        target="_blank"
        rel="noopener"
        >愛知県新型コロナウイルス感染症について</a
      >を参照して作成しました。（データは順次追加予定です）
    </TextCard>
    ...
    <TextCard title="お問い合わせ先">
      現時点では無し。リアルで知っている方がいたらメールでお願いします。
    </TextCard>
  </div>
</template>
